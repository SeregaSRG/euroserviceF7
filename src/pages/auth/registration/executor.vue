<template>
  <div class="client-registration">
    <div class="input__wrapper">
      ...
      ></mf-input>
      <competencies-input
          :competencies.sync="credentials.competencies"
          :valid-condition="validCompetencies"
      ></competencies-input>
      <mf-input
...
<script>
  ...
  import CustomerApi from '../../../services/api/modules/customer'
  ...
  export default {
    ...
    computed: {
      ...
      validCompetencies() {
        return this.credentials.competencies.length !== 0
      }
    },
    data() {
      return {
    ...
    methods: {
      ...
      registration() {
        ...
        Api.registration({
          ...
          "works": this.credentials.competencies
        }).then(data => {
          console.log(data)
